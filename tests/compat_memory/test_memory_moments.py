...
def test_source_ref_window_rejects_absolute_paths_without_an_allowed_root(tmp_path):
    ...
    assert source_ref_window(moment) == ""
    assert source_ref_window(moment, allowed_root=str(tmp_path)) == "private source text"
